...
class RecModel(object):
    def __init__(self, params):
        ...
        if "TPS" in params:
            ...
            self.tps = create_module(tps_params['function'])(params=tps_params)
        else:
            self.tps = None
    ...
    def create_feed(self, mode):
        ...
        if mode == "train":
            ...
            image.stop_gradient = False     # add: libo
            if self.loss_type == "attention":
                ...
                label = fluid.data(name='label', shape=[-1, 1], dtype='int32', lod_level=1)
                feed_list = [
    ...
    def __call__(self, mode):
        ...
        if mode == "train":
            ...
            if self.loss_type == 'srn':
                ...
                outputs = {'total_loss':loss, 'decoded_out': decoded_out, 'label':label}
            ...
            if self.loss_type == "srn":
                return [image, labels, {'decoded_out': decoded_out, 'predicts': predict}]
