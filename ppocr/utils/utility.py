...
def create_module(module_str):
    ...
    # print('tmpss: ', tmpss)         # tmpss:  ['ppocr.modeling.architectures.det_model', 'DetModel']
    assert len(tmpss) == 2, "Error formate of the module path: {}".format(module_str)
    module_name, function_name = tmpss[0], tmpss[1]
    # print('***************: ', module_name)     # ppocr.modeling.architectures.det_model
    # print('---------------: ', function_name)   # DetModel
